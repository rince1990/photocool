...
namespace Proxies\__CG__\AdrianG\RegisterBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \AdrianG\RegisterBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'galleries', '' . "\0" . 'AdrianG\\RegisterBundle\\Entity\\User' . "\0" . 'users_access');
        }
    ...
    public function addGalleries(\multimediaBundle\Entity\Gallery $galleries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addGalleries', array($galleries));

        return parent::addGalleries($galleries);
    }
