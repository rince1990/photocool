 ...
 */
class Image extends \multimediaBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'multimediaBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'multimediaBundle\\Entity\\Image' . "\0" . 'imageFile', '' . "\0" . 'multimediaBundle\\Entity\\Image' . "\0" . 'imageName', '' . "\0" . 'multimediaBundle\\Entity\\Image' . "\0" . 'updatedAt');
        }
